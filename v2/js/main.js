// IMPERIUM v2 — huvudflöde: städer, landsfakta, tillgångar, handelsrutter
...
const state = {
  ...
  players: [],
  me: null,
  cities: {},          // countryId -> [städer]
  facts: {},           // countryId -> {p, c, a2}
  mapLevel: null,
  tvTimer: null,
};
...
function buildRoutes(citiesByCountry) {
  ...
  // varje huvudstad ↔ 2 närmaste utländska huvudstäderna
  const seen = new Set();
